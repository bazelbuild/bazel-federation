...
def rules_go_setup():
    ...
    # Prevent rules_go from bringing in any repository dependencies.
    ...
    assert_unmodified_repositories(
        snapshot, whitelist=("io_bazel_rules_go_compat", "gogo_special_proto", "io_bazel_rules_nogo")
    )
